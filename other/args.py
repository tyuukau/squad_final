...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        default='./data/cached-train-data')    
    parser.add_argument('--dev_eval_file',
                        type=str,
                        default='./data/cached-dev')
    parser.add_argument('--test_eval_file',
                        type=str,
                        default='./data/cached-test')
    parser.add_argument('--char_emb_file',
                        type=str,
                        default='./data/char_emb.json')
    parser.add_argument('--dev_gold_file',
                        type=str,
                        default='./data/dev_gold_dict.json')
    parser.add_argument('--dev_logits_save_file',
                        type=str,
                        default=None)
    parser.add_argument('--model_name',
                        type=str,
                        default='albert-base-v2',
                        help='''Name of the model, choose from:
                                albert-base-v2    # AlbertForQuestionAnswering
                                albert-xlarge-v2  # AlbertForQuestionAnswering
                                albert-xxlarge-v2 # AlbertForQuestionAnswering
                                albert_highway 
                                albert_lstm_highway 
                                albert_bidaf 
                                albert_bidaf2
    ...
    parser.add_argument('--dev_record_file',
                        type=str,
                        default='./data/cached-dev-data')
    parser.add_argument('--test_record_file',
                        type=str,
                        default='./data/cached-test-data')
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--large',
                        type=bool,
                        default=False,
                        help='Whether using the large model (albert_large)')
    parser.add_argument('--xxlarge',
                        type=bool,
                        default=False,
                        help='Whether using the xxlarge model, make sure to set it to true when using the xxlarge model and dataset')
