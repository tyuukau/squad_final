"""
Download and pre-process SQuAD.
...
# Own dependencies
from other.args import get_setup_args
...
def process_file(filename, data_type, char_counter):
...
def pre_process(args):
    ...
    train_examples, train_eval = process_file(args.train_file, "train", char_counter)
    ...
    dev_examples, dev_eval = process_file(args.dev_file, "dev", char_counter)
    ...
    if args.include_test_examples:
        test_examples, test_eval = process_file(args.test_file, "test", char_counter)
